...
/* harmony import */ var _control_control_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./control/control.component */ "./src/app/control/control.component.ts");
/* harmony import */ var _exploracion_exploracion_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./exploracion/exploracion.component */ "./src/app/exploracion/exploracion.component.ts");
...
var routes = [
    ...
    { path: 'control', component: _control_control_component__WEBPACK_IMPORTED_MODULE_3__["ControlComponent"] },
    { path: 'planetas', component: _exploracion_exploracion_component__WEBPACK_IMPORTED_MODULE_4__["ExploracionComponent"] },
    { path: 'planetas/:planeta', component: _exploracion_exploracion_component__WEBPACK_IMPORTED_MODULE_4__["ExploracionComponent"] }
];
...
/* harmony import */ var _fuselaje_fuselaje_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fuselaje/fuselaje.component */ "./src/app/fuselaje/fuselaje.component.ts");
/* harmony import */ var _motor_motor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./motor/motor.component */ "./src/app/motor/motor.component.ts");
/* harmony import */ var _cabina_cabina_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cabina/cabina.component */ "./src/app/cabina/cabina.component.ts");
...
/* harmony import */ var _control_control_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./control/control.component */ "./src/app/control/control.component.ts");
/* harmony import */ var _exploracion_exploracion_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./exploracion/exploracion.component */ "./src/app/exploracion/exploracion.component.ts");
/* harmony import */ var _planeta_planeta_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./planeta/planeta.component */ "./src/app/planeta/planeta.component.ts");
/* harmony import */ var _format_degrees_pipe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./format-degrees.pipe */ "./src/app/format-degrees.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _fuselaje_fuselaje_component__WEBPACK_IMPORTED_MODULE_4__["FuselajeComponent"],
                _motor_motor_component__WEBPACK_IMPORTED_MODULE_5__["MotorComponent"],
                _cabina_cabina_component__WEBPACK_IMPORTED_MODULE_6__["CabinaComponent"],
                ...
                _control_control_component__WEBPACK_IMPORTED_MODULE_10__["ControlComponent"],
                _exploracion_exploracion_component__WEBPACK_IMPORTED_MODULE_11__["ExploracionComponent"],
                _planeta_planeta_component__WEBPACK_IMPORTED_MODULE_12__["PlanetaComponent"],
                _format_degrees_pipe__WEBPACK_IMPORTED_MODULE_13__["FormatDegreesPipe"]
            ],
            imports: [
...
/***/ "./src/app/cabina/cabina.component.css":
/*!*********************************************!*\
  !*** ./src/app/cabina/cabina.component.css ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/app/cabina/cabina.component.html":
/*!**********************************************!*\
  !*** ./src/app/cabina/cabina.component.html ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "<section class=\"cabin\">\n    <div class=\"counter\">{{ counter }}</div>\n</section>"

/***/ }),

/***/ "./src/app/cabina/cabina.component.ts":
/*!********************************************!*\
  !*** ./src/app/cabina/cabina.component.ts ***!
  \********************************************/
/*! exports provided: CabinaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CabinaComponent", function() { return CabinaComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _contador_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../contador.service */ "./src/app/contador.service.ts");
...
var CabinaComponent = /** @class */ (function () {
    function CabinaComponent(contadorService) {
        var _this = this;
        this.contadorService = contadorService;
        this.secondsCounter = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(1000);
        this.counter = 10;
        this.time = 10;
        this.subscription = contadorService.timerAnnounced$.subscribe(function (start) {
            _this.handleCounter(start);
        });
    }
    CabinaComponent.prototype.handleCounter = function (start) {
        if (start) {
            this.startCounter();
        }
        else {
    ...
    CabinaComponent.prototype.startCounter = function () {
        var _this = this;
        if (this.counter != 0 && this.counter != this.time) {
            return;
        }
        this.counterSubscription = this.secondsCounter.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(this.time), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (v) { return (_this.time - 1) - v; })).subscribe(function (v) { return _this.counter = v; });
    };
    CabinaComponent.prototype.resetCounter = function () {
        if (this.counterSubscription) {
            this.counterSubscription.unsubscribe();
            this.counter = this.time;
        }
    };
    CabinaComponent.prototype.ngOnInit = function () {
    };
    CabinaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-cabina',
            template: __webpack_require__(/*! ./cabina.component.html */ "./src/app/cabina/cabina.component.html"),
            styles: [__webpack_require__(/*! ./cabina.component.css */ "./src/app/cabina/cabina.component.css")]
        }),
        __metadata("design:paramtypes", [_contador_service__WEBPACK_IMPORTED_MODULE_1__["ContadorService"]])
    ], CabinaComponent);
    return CabinaComponent;
}());
...
var ContadorService = /** @class */ (function () {
    function ContadorService() {
        ...
        this.timerAnnouncedSource = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        // Observable boolean streams
        this.timerAnnounced$ = this.timerAnnouncedSource.asObservable();
    }
    // service  boolean commands
    ContadorService.prototype.announceTimer = function (start) {
...
module.exports = "<app-fuselaje></app-fuselaje>\n<app-cabina></app-cabina>\n<app-motor></app-motor>\n\n\n\n"
...
/***/ "./src/app/exploracion/exploracion.component.css":
/*!*******************************************************!*\
  !*** ./src/app/exploracion/exploracion.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = ".exploracion {\n\tposition: absolute;\n\tz-index: 9999;\n\tmargin: 1em;\n}\n\nbutton {\n\tpadding: 0.5em;\n\tmargin: 0.5em 0;\n\tcursor: pointer;\n\tbackground-color: white;\n\tborder-radius: 4px;\n\tborder: none;\n\twidth: 150px;\n}\n\nbutton:hover {\n\tbackground-color: rgba(255,255, 255, 0.7);\n}\n\n.selected {\n\tbackground-color: rgba(255,255, 255, 0.5)\n}"

/***/ }),

/***/ "./src/app/exploracion/exploracion.component.html":
/*!********************************************************!*\
  !*** ./src/app/exploracion/exploracion.component.html ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"exploracion\">\n  <h1>planetas</h1>\n  <div *ngFor=\"let planet of planetas\">\n  \t\n    <button [class.selected]=\"planet === selectedPlanet\" (click)=\"selectPlanet(planet)\">{{planet.name}}</button>\n  </div>\n</div>\n<app-fuselaje></app-fuselaje>"

/***/ }),

/***/ "./src/app/exploracion/exploracion.component.ts":
/*!******************************************************!*\
  !*** ./src/app/exploracion/exploracion.component.ts ***!
  \******************************************************/
/*! exports provided: ExploracionComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExploracionComponent", function() { return ExploracionComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _planetas_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../planetas.service */ "./src/app/planetas.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ExploracionComponent = /** @class */ (function () {
    function ExploracionComponent(route, location, planetasService) {
        this.route = route;
        this.location = location;
        this.planetasService = planetasService;
    }
    ExploracionComponent.prototype.ngOnInit = function () {
        this.getPlanetas();
    };
    ExploracionComponent.prototype.getPlanetas = function () {
        var _this = this;
        this.planetasService.getPlanetas()
            .subscribe(function (d) { return _this.setPlanetas(d.images); });
    };
    ExploracionComponent.prototype.loadPlanet = function () {
        // if url has planet -> selectPlanet(iterate over this.planetas)
        var name = this.route.snapshot.paramMap.get('planeta');
        if (name) {
            var selected = this.planetas.filter(function (d) { return d.name == name; });
            if (selected.length != 0) {
                this.selectPlanet(selected[0]);
            }
        }
    };
    ExploracionComponent.prototype.setPlanetas = function (images) {
        var arr = [];
        Object.keys(images).forEach(function (key, index) {
            var planeta = { name: key, img: images[key].img, degrees: +images[key].degrees };
            arr.push(planeta);
        });
        this.planetas = arr;
        this.loadPlanet();
    };
    ExploracionComponent.prototype.selectPlanet = function (planet) {
        this.selectedPlanet = planet;
        this.planetasService.announcePlanet(planet);
        // go to url
        this.location.go("/planetas/" + planet.name);
    };
    ExploracionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-exploracion',
            template: __webpack_require__(/*! ./exploracion.component.html */ "./src/app/exploracion/exploracion.component.html"),
            styles: [__webpack_require__(/*! ./exploracion.component.css */ "./src/app/exploracion/exploracion.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"],
            _planetas_service__WEBPACK_IMPORTED_MODULE_3__["PlanetasService"]])
    ], ExploracionComponent);
    return ExploracionComponent;
}());
...
/***/ "./src/app/format-degrees.pipe.ts":
/*!****************************************!*\
  !*** ./src/app/format-degrees.pipe.ts ***!
  \****************************************/
/*! exports provided: FormatDegreesPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormatDegreesPipe", function() { return FormatDegreesPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 *   formats to: 25.0000
*/
var FormatDegreesPipe = /** @class */ (function () {
    function FormatDegreesPipe() {
    }
    FormatDegreesPipe.prototype.transform = function (value) {
        var exp = parseFloat(value).toFixed(4) + '';
        return exp;
    };
    FormatDegreesPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: 'formatDegrees' })
    ], FormatDegreesPipe);
    return FormatDegreesPipe;
}());
...
/***/ "./src/app/fuselaje/fuselaje.component.css":
/*!*************************************************!*\
  !*** ./src/app/fuselaje/fuselaje.component.css ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "\n.space {\n    position: absolute;\n    top:8vh;\n    height: 92vh;\n    width: 100%;\n}\n.rocket {\n    position: absolute;\n    top: 0;\n    left: 0;\n    height: 92vh;\n    width: 100%;\n    background: url(/dist/web/assets/spaceship.svg) no-repeat center;\n}\n.rocket path {\n    fill: white;\n\n}\n.tresA {\n    width: auto;\n    position: absolute;\n    bottom: 0;\n    right: 1%;\n}\n.tresA > img {\n    float: right;\n    width: 70%;\n}\n.status {\n    text-align: center;\n}\n.status > h3 {\n    padding-top: 2%;\n    text-shadow: 0px 0px 20px #FFF;\n    font-size: 24px;\n    z-index: 9999;\n}\n.img-planet {\n    /*border: 1px solid white;*/\n    width: 100%;\n    position: absolute;\n    top: 25vh;\n    display: flex;\n    justify-content: center;\n    align-content: center;\n    \n    z-index: -1;\n}"

/***/ }),

/***/ "./src/app/fuselaje/fuselaje.component.html":
/*!**************************************************!*\
  !*** ./src/app/fuselaje/fuselaje.component.html ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"space\">\n    <section class=\"status\">\n        <h3>Planeta {{planeta}} avistado a {{grados | formatDegrees }} grados</h3>\n    </section>\n    <section class=\"rocket\">\n        \n    </section>\n    <div class=\"tresA\">\n        <img src=\"/assets/logo.png\" alt=\"\">\n    </div>\n</div>\n<div class=\"img-planet\">\n\t<img src={{img}}/>\n</div>"

/***/ }),

/***/ "./src/app/fuselaje/fuselaje.component.ts":
/*!************************************************!*\
  !*** ./src/app/fuselaje/fuselaje.component.ts ***!
  \************************************************/
/*! exports provided: FuselajeComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuselajeComponent", function() { return FuselajeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _planetas_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../planetas.service */ "./src/app/planetas.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FuselajeComponent = /** @class */ (function () {
    function FuselajeComponent(planetasService) {
        var _this = this;
        this.planetasService = planetasService;
        this.planeta = 'X';
        this.grados = 0;
        this.img = '';
        this.subscription = planetasService.planetAnnounced$.subscribe(function (planet) {
            _this.handleSelection(planet);
        });
    }
    FuselajeComponent.prototype.handleSelection = function (planet) {
        this.planeta = planet.name;
        this.grados = planet.degrees;
        this.img = planet.img;
        this.getMessage();
    };
    FuselajeComponent.prototype.ngOnInit = function () {
        this.getMessage();
    };
    FuselajeComponent.prototype.getMessage = function () {
        this.message = "Planeta " + this.planeta + " avistado a " + this.grados + " grados";
    };
    FuselajeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-fuselaje',
            template: __webpack_require__(/*! ./fuselaje.component.html */ "./src/app/fuselaje/fuselaje.component.html"),
            styles: [__webpack_require__(/*! ./fuselaje.component.css */ "./src/app/fuselaje/fuselaje.component.css")]
        }),
        __metadata("design:paramtypes", [_planetas_service__WEBPACK_IMPORTED_MODULE_1__["PlanetasService"]])
    ], FuselajeComponent);
    return FuselajeComponent;
}());
...
module.exports = "<nav>\n  <ul>\n    <li *ngFor=\"let route of routes\">\n      <a [class.active]=\"route === selectedRoute\" routerLink=\"/{{route}}\">{{ route }}</a> \n    </li>\n  </ul>\n</nav>"
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(route) {
        this.route = route;
        this.routes = ["inicio", "control", "planetas"];
    }
    ...
    MenuComponent.prototype.getSelectedRoute = function () {
...
/***/ "./src/app/motor/motor.component.css":
/*!*******************************************!*\
  !*** ./src/app/motor/motor.component.css ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/app/motor/motor.component.html":
/*!********************************************!*\
  !*** ./src/app/motor/motor.component.html ***!
  \********************************************/
/*! no static exports found */
...
module.exports = "<section class=\"motor\">\n    <button class=\"round-button\" (click)=\"ignite()\">ignite</button>\n\t<button class=\"round-button\" (click)=\"reset()\">reset</button>\n</section>\n\n\n\n\n"

/***/ }),

/***/ "./src/app/motor/motor.component.ts":
/*!******************************************!*\
  !*** ./src/app/motor/motor.component.ts ***!
  \******************************************/
...
var MotorComponent = /** @class */ (function () {
    function MotorComponent(contadorService, route, location) {
        this.contadorService = contadorService;
        this.route = route;
        this.location = location;
    }
    ...
    MotorComponent.prototype.setRoute = function () {
        var _this = this;
        this.route.url
            .subscribe(function (routeName) { return _this.routeName = routeName[0].path; });
    };
    MotorComponent.prototype.ignite = function () {
        if (this.routeName === 'inicio') {
            return;
        }
        this.contadorService.announceTimer(true);
    };
    MotorComponent.prototype.reset = function () {
        if (this.routeName === 'inicio') {
            return;
        }
    ...
    MotorComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-motor',
            template: __webpack_require__(/*! ./motor.component.html */ "./src/app/motor/motor.component.html"),
            styles: [__webpack_require__(/*! ./motor.component.css */ "./src/app/motor/motor.component.css")]
        }),
        __metadata("design:paramtypes", [_contador_service__WEBPACK_IMPORTED_MODULE_1__["ContadorService"],
...
/***/ "./src/app/planeta/planeta.component.css":
/*!***********************************************!*\
  !*** ./src/app/planeta/planeta.component.css ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/app/planeta/planeta.component.html":
/*!************************************************!*\
  !*** ./src/app/planeta/planeta.component.html ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/app/planeta/planeta.component.ts":
/*!**********************************************!*\
  !*** ./src/app/planeta/planeta.component.ts ***!
  \**********************************************/
/*! exports provided: PlanetaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlanetaComponent", function() { return PlanetaComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var PlanetaComponent = /** @class */ (function () {
    function PlanetaComponent(route, location) {
        this.route = route;
        this.location = location;
    }
    PlanetaComponent.prototype.ngOnInit = function () {
        this.getPlaneta();
    };
    PlanetaComponent.prototype.getPlaneta = function () {
        this.planeta = this.route.snapshot.paramMap.get('planeta');
    };
    PlanetaComponent.prototype.goBack = function () {
        this.location.back();
    };
    PlanetaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-planeta',
            template: __webpack_require__(/*! ./planeta.component.html */ "./src/app/planeta/planeta.component.html"),
            styles: [__webpack_require__(/*! ./planeta.component.css */ "./src/app/planeta/planeta.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"]])
    ], PlanetaComponent);
    return PlanetaComponent;
}());
...
var PlanetasService = /** @class */ (function () {
    function PlanetasService(http) {
        this.http = http;
        this.url = 'http://demo0761779.mockable.io/angularspaceship/planets';
        // Observable Planeta sources
        this.planetAnnouncedSource = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        // Observable Planeta streams
        this.planetAnnounced$ = this.planetAnnouncedSource.asObservable();
    }
    PlanetasService.prototype.getPlanetas = function () {
        return this.http.get(this.url);
    };
    // service  Planeta commands
    PlanetasService.prototype.announcePlanet = function (planet) {
        console.log(planet);
...
module.exports = __webpack_require__(/*! /Users/juanmurillo/projects/angular6/web/src/main.ts */"./src/main.ts");
